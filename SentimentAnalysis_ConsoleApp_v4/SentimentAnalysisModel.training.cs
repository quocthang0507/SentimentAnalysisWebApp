	...
	public partial class SentimentAnalysisModel
	{
		...
		public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
		{
			...
			var pipeline = mlContext.Transforms.Text.FeaturizeText(@"col3", @"col3")
									...
									.Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(l1Regularization: 0.03125F, l2Regularization: 0.0557031447710777F, labelColumnName: @"col2", featureColumnName: @"Features"))
